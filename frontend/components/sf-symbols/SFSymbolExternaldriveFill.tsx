interface SFSymbolExternaldriveFillProps {
  /**
 ...
 */
export function SFSymbolExternaldriveFill({
  size = 24,
  color = 'currentColor',
  className = '',
  strokeWidth = 1,
  ...rest
}: SFSymbolExternaldriveFillProps): JSX.Element {
