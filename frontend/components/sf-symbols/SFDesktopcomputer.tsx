interface SFDesktopcomputerProps {
  /**
 ...
 */
export function SFDesktopcomputer({
  size = 24,
  color = 'currentColor',
  className = '',
  strokeWidth = 1,
  ...rest
}: SFDesktopcomputerProps): JSX.Element {
