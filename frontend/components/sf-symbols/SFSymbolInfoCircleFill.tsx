interface SFSymbolInfoCircleFillProps {
  /**
...
/**
 * InfoCircleFill Icon Component
 *
 * A custom SVG icon from SF Symbols.
 * Follows the same API conventions as React Icons library components.
 *
 * @param {SFSymbolInfoCircleFillProps} props - Component props
 * @returns {JSX.Element} The SVG icon element
 *
 * @example
 * // Basic usage
 * <SFSymbolInfoCircleFill size={24} color="currentColor" />
 *
 * @example
 * // With custom styling
 * <SFSymbolInfoCircleFill size={32} color="#ff0000" className="custom-class" />
 */
export function SFSymbolInfoCircleFill({
  size = 24,
  color = 'currentColor',
  className = '',
  strokeWidth = 1,
  ...rest
}: SFSymbolInfoCircleFillProps): JSX.Element {
