interface SFSymbolMoonStarsProps {
  /**
 ...
 */
export function SFSymbolMoonStars({
  size = 24,
  color = 'currentColor',
  className = '',
  strokeWidth = 1,
  ...rest
}: SFSymbolMoonStarsProps): JSX.Element {
