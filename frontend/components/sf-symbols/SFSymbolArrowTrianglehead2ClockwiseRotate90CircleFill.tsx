interface SFSymbolArrowTrianglehead2ClockwiseRotate90CircleFillProps {
  /**
 ...
 */
export function SFSymbolArrowTrianglehead2ClockwiseRotate90CircleFill({
  size = 24,
  color = 'currentColor',
  className = '',
  strokeWidth = 1,
  ...rest
}: SFSymbolArrowTrianglehead2ClockwiseRotate90CircleFillProps): JSX.Element {
