...
export const it: Translations = {
  ...
  login: {
    ...
    setupTitle: `Benvenuto in ${appName}`,
    confirmPassword: 'Conferma password',
    confirmPasswordPlaceholder: 'Inserisci nuovamente la password',
    createAccount: 'Crea account',
    creatingAccount: 'Creazione account...',
    databaseImportFailed: 'Importazione database fallita: {error}',
    databaseImportSuccess: 'Database importato con successo! {count} configurazioni ripristinate. Effettua il login con un utente esistente.',
    passwordMismatch: 'Le password non corrispondono',
    loginFailed: 'Accesso fallito',
    or: 'o',
    importingDatabase: 'Importazione database...',
    importExistingDatabase: 'Importa database esistente',
    importDatabaseHint: 'Ripristina da un file di backup del database esportato in precedenza',
  },
  layout: {
    title: appName,
    subtitle: 'Gestore di configurazione NeXT Computer',
