...
export const en: Translations = {
  ...
  configEditor: {
    ...
    configurationDescriptionPlaceholder: 'Enter configuration description',
    ...
    noConfigSelectedDescription: 'Please select a config to edit or make a config the active configuration.',
    ...
    goToSavedConfigs: 'Go to Saved Configs',
  },
  configList: {
    active: 'Active',
    cancel: 'Cancel',
